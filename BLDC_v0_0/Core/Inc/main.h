...
#define INLC_Pin GPIO_PIN_14
#define INLC_GPIO_Port GPIOC
#define INLB_Pin GPIO_PIN_15
...
#define TestPoint0_Pin GPIO_PIN_4
#define TestPoint0_GPIO_Port GPIOB
#define TestPoint1_Pin GPIO_PIN_5
